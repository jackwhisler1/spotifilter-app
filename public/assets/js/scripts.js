...
(function ($) {
    ...
    modal: function () {
      ...
      $(".modal").on("hidden.bs.modal", function () {
        ...
        if ($().mediaelementplayer) {
          $(this)
            .find(".mejs__container video")
            .each(function () {
              this.player.pause();
            });

          $(this)
            .find(".mejs__container audio")
            .each(function () {
              this.player.pause();
            });
        }
  ...
  GRAPHICFORT.fitVidsfn = {
    ...
    init: function () {
      if ($().fitVids) {
        $("body").fitVids({
          customSelector:
            'iframe[src*="soundcloud.com"], iframe[src*="videopress.com"], iframe[src*="player.twitch.tv"], iframe[src*="maps.google.com"], iframe[src*="google.com/maps"], iframe[src*="dailymotion.com"]',
        });
      }
    },
  };
      ...
      $("body").on("click", ".data-scroll-to, [data-scroll-to]", function () {
        if ($(this.hash).length) {
          ...
          if ($(".header-section").hasClass("header-section-fixed") && !isMobile.any()) {
            $("html, body").animate(
              {
                scrollTop: $(id).offset().top - $(".header-section-fixed .header-menu-section-container").height() + 2,
              },
              800
            );
          } else {
  ...
  GRAPHICFORT.headerfn = {
    ...
    mobileMenu: function () {
      ...
      $(".desktop-menu").clone().attr({ class: mobileContainerClass }).appendTo($(".mobile-menu"));
    },
    // Current Page
    currentPage: function () {
      var currentPageFileName, el;
    ...
    validation: function () {
      $(".form-block-validation").each(function () {
        ...
        if (el.hasClass("form-block-contact")) {
          form.prepend(
            '<input type="hidden" class="form_domain" name="form_domain" value="' + document.location.hostname + '">'
          );
        }
              ...
              $.ajax({
                ...
                if (response.match("success-message") !== null) {
                  if (redirect) {
                    ...
                    form.append(
                      '<div class="form-message col-lg-12"><div class="alert alert-success">' +
                        response +
                        "</div></div>"
                    );
                  }
                ...
                if (response.match("error-message") !== null) {
                  form.append(
                    '<div class="form-message col-lg-12"><div class="alert alert-danger">' + response + "</div></div>"
                  );
                }
    ...
    init: function () {
      if ($().isotope) {
        $(".isotope-grid").each(function () {
          ...
          transitionDuration = !transitionDuration && transitionDuration !== 0 ? 0.4 : transitionDuration;
    ...
    init: function () {
      if ($().owlCarousel) {
        $(".owl-slider").each(function () {
          ...
          /* Items
                    --------------------------------------------------------- */
          itemsXL = !itemsXL ? 1 : itemsXL;

          itemsLG = !itemsLG ? 1 : itemsLG;

          itemsMD = !itemsMD ? 1 : itemsMD;

          itemsSM = !itemsSM ? 1 : itemsSM;

          itemsXS = !itemsXS ? 1 : itemsXS;
          ...
          if (thumbnailSlider === "yes") {
            el.next(".owl-slider-thumbnail")
              .find(".owl-slider-item")
              .each(function (index) {
          ...
          el.owlCarousel({
            ...
            onTranslate: function (elem) {
              ...
              if (thumbnailSlider === "yes") {
                ...
                el.next(".owl-slider-thumbnail")
                  .find('[data-owl-slider-jump-to="' + thumbnailSliderActiveItem + '"]')
                  .addClass("owl-slider-active-item");
              }
            },
            onResized: function () {
              // Auto height
          ...
          $("body").on("click", "[data-owl-slider-jump-to]", function (e) {
            ...
            $(this)
              .parents(".owl-slider-thumbnail")
              .find(".owl-slider-active-item")
              .removeClass("owl-slider-active-item");
            ...
            $(this)
              .parents(".owl-slider-thumbnail")
              .prev(".owl-slider")
              .trigger("to.owl.carousel", [$(this).attr("data-owl-slider-jump-to"), 600, true]);
          });
        });
      }
    },
        ...
        $.ajax({
          ...
          success: function (response) {
            if (response.result === "error") {
              form.append(
                '<div class="form-message col-lg-12"><div class="alert alert-danger">' + response.msg + "</div></div>"
              );

              form.find('input[type="email"]').addClass("error");
            } else {
              form.append(
                '<div class="form-message col-lg-12"><div class="alert alert-success">' + response.msg + "</div></div>"
              );
  ...
  GRAPHICFORT.notificationsfn = {
    ...
    init: function () {
      $(".notification-block").each(function () {
        ...
        cookieName = !cookieName ? "GRAPHICFORT" : cookieName;
      ...
      $(".btn-notification-dismiss").on("click", function () {
        ...
        cookieEXdays = !cookieEXdays ? 0 : cookieEXdays;
    ...
    init: function () {
      if ($().easyPieChart) {
        $(".pie-chart-block").each(function () {
          ...
          container.prepend(
            '<div class="main-block-header pie-chart-block-header"><div class="pie-chart-block-circle"></div><h3 class="pie-chart-block-percent" style="color: ' +
              barColor +
              '"><span data-from="0" data-to="' +
              percent +
              '" data-speed="1000" data-interval="50">' +
              percent +
      ...
      $(".youtube-bg-video").each(function (index) {
        ...
        if (!isMobile.any()) {
          ...
          src =
            ...
            videoID +
            "?enablejsapi=1&iv_load_policy=3&enablejsapi=1&disablekb=1&controls=0&widgetid=1&showinfo=0&loop=1&&playlist=" +
            videoID +
            "&rel=0" +
            mute +
            autoplay;
          ...
          el.append(
            '<iframe src="' +
              src +
              '" id="youtube-iframe-bg-video-' +
              index +
              '" class="youtube-iframe-bg-video"></iframe>'
          );
        ...
        /* Youtube Play btn (Mobile)
                ------------------------------------------------------------- */
        if (isMobile.any()) {
          el.parent(".section-media-bg").after(
            '<a class="btn-youtube-bg-video" href="' + url + '" data-lightbox title="Play"></a>'
          );
        }
    ...
    init: function () {
      if ($().tweetie) {
        $(".twitter-feed-block").each(function () {
          ...
          /* Columns
                    --------------------------------------------------------- */
          colXL = !colXL ? "col-xl-12" : colXL;

          colLG = !colLG ? "col-lg-12" : colLG;

          colMD = !colMD ? "col-md-12" : colMD;

          colSM = !colSM ? "col-sm-12" : colXL;

          colXS = !colXS ? "col-12" : colXS;
          ...
          if (slider !== "yes" && el.hasClass("twitter-feed-block-layout-2")) {
            template +=
              '<div class="isotope-item ' + colXL + " " + colLG + " " + colMD + " " + colSM + " " + colXS + '">';
          }
          ...
          template +=
            '<a href="https://twitter.com/{{tweet.user.screen_name}}/" target="_blank" rel="noopener">{{tweet.user.name}}</a>';
          template +=
            '<a href="https://twitter.com/{{tweet.user.screen_name}}/" target="_blank" rel="noopener" title="{{tweet.user.name}}" class="bird"><i class="fab fa-twitter"></i></a>';
          template += "</h6>";
          template += '<h6 class="screen-name">';
          template +=
            '<a href="https://twitter.com/{{tweet.user.screen_name}}/" target="_blank" rel="noopener">&commat;{{tweet.user.screen_name}}</a>';
          template += "</h6>";
          template += "</div>";
          ...
          template +=
            '<a href="https://twitter.com/{{tweet.user.screen_name}}/status/{{tweet.id_str}}" target="_blank" rel="noopener">{{tweet.created_at}}</a>';
          template += "</div>";

          template += '<div class="action-buttons">';
          template +=
            '<a class="reply" href="https://twitter.com/intent/tweet?in_reply_to={{tweet.id_str}}" target="_blank" rel="noopener" title="Reply" data-bs-toggle="tooltip" data-bs-original-title="Reply"><i class="far fa-comment-alt"></i></a>';
          template +=
            '<a class="retweet" href="https://twitter.com/intent/retweet?tweet_id={{tweet.id_str}}" target="_blank" rel="noopener" title="Retweet" data-bs-toggle="tooltip" data-bs-toggle-original-title="Retweet"><i class="fas fa-retweet"></i></a>';
          template +=
            '<a class="favorite" href="https://twitter.com/intent/favorite?tweet_id={{tweet.id_str}}" target="_blank" rel="noopener" title="Like" data-bs-toggle="tooltip" data-bs-toggle-original-title="Like"><i class="far fa-heart"></i></a>';
          template += "</div>";
  ...
  GRAPHICFORT.shopfn = {
    ...
    reviewLink: function () {
      $("body").on("click", ".product-rating a", function (e) {
        if ($(this.hash).length) {
          ...
          $(this)
            .parents(".shop-block-inner")
            .find(".nav-tabs .nav-link")
            .each(function () {
              link = $(this);
                  ...
                  $("html, body").animate(
                    {
                      scrollTop:
                        $("#" + linkAttr).offset().top -
                        $(".header-section-fixed .header-menu-section-container").height(),
                    },
                    800
                  );
                } else {
    ...
    paymentMethod: function () {
      ...
      $('#payment li input[type="radio"]').on("change", function () {
        $(this)
          .parents("ul")
          .find(".payment-content:not(.radio)")
          .each(function () {
            $(this).slideUp();
          });
    ...
    init: function () {
      if ($().appear) {
        $("[data-animation]").each(function () {
          ...
          animateDelay = !animateDelay ? 500 : animateDelay + 500;
